...
# 指定要运行的Python文件和参数
python_file = "/home/yuance/Work/Trianglecounting/undirected_local.py"
arguments = [("node", "1", "30", "20", "20", "0.3", "0.3")]
...
def run_script(args):
    ...
    output_file = f"/home/yuance/Work/Trianglecounting/output/data/undirected_local/{_type}_{idx}.txt"
